...
class LoadAerialImageFromFile(object):
    ...
    Expects results['aerial_image_path'] to be a path to an image.
    ...
    def __call__(self, results):
        """Call function to load aerial image from file.

        Args:
            results (dict): Result dict containing aerial image path.
