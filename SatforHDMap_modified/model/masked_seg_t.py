...
from .align import AlignFusion


class Fusion_Atten_Masked_Seg(nn.Module):
    def __init__(self,
                 bev_channels, prior_channels, hidden_c, align_fusion,
        ...
        super(Fusion_Atten_Masked_Seg, self).__init__()
    ...
    def forward(self, bev_features, prior_features, segmentation):
        ...
        if self.align_fusion:
            prior_features = self.alignfusion(prior_features, x)
