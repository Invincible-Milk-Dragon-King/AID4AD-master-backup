...
from .hdmapnet_legacy import HDMapNetLegacy
...
def get_model(method, data_conf, args, instance_seg=True, embedded_dim=16, direction_pred=True, angle_class=36):
    ...
    elif method == 'HDMapNet_cam_legacy':
        model = HDMapNetLegacy(data_conf, args, instance_seg=instance_seg, embedded_dim=embedded_dim, direction_pred=direction_pred, direction_dim=angle_class, lidar=False)
