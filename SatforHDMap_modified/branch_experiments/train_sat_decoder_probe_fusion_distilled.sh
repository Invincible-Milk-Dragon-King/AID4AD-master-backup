...
LOGDIR="${LOGDIR:-./branch_runs/sat_decoder_probe_fusion_distilled}"
CHECKPOINT="${CHECKPOINT:-./branch_runs/fusion_distilled_satellite/model_last.pt}"
...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES}" python -m torch.distributed.launch \
  ...
  --experiment_name sat_decoder_probe_fusion_distilled \
