...
LOGDIR="${LOGDIR:-./branch_runs/camera_decoder_probe_fusion_distilled}"
CHECKPOINT="${CHECKPOINT:-./branch_runs/fusion_distilled_camera/model_last.pt}"
...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES}" python -m torch.distributed.launch \
  ...
  --experiment_name camera_decoder_probe_fusion_distilled \
