...
LOGDIR="${LOGDIR:-./branch_runs/fusion_distilled_drop_camera}"
MODEL="${MODEL:-./branch_runs/fusion_distilled_satellite/model_last.pt}"
...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES}" python test.py \
  ...
  --experiment_name fusion_distilled_drop_camera \
