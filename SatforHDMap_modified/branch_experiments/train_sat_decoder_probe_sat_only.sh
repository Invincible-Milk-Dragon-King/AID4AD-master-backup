...
LOGDIR="${LOGDIR:-./branch_runs/sat_decoder_probe_sat_only}"
CHECKPOINT="${CHECKPOINT:-./branch_runs/sat_only/model_last.pt}"
...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES}" python -m torch.distributed.launch \
  ...
  --experiment_name sat_decoder_probe_sat_only \
